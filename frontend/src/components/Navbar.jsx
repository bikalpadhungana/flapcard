    ...
    <header className="bg-green-100 shadow-md">
      <div className="flex justify-between items-center max-w-6xl mx-auto p-6">
        ...
        {user &&
          <ul>
            <Link to="profile">
              <li className="text-black bg-green-400 hover:opacity-75 transition-all duration-500 cursor-pointer border-4 rounded-full border-green-400 p-2 w-24 text-center">Profile</li>
            </Link>
          </ul>  
        }
