...
>
  Exchange Contact Info
        ...
        <form className="w-full flex flex-col gap-4 flex-grow justify-center">
          ...
          <main className="hp-profile-container">
            <header className="hp-profile-header">
            <div className="hp-cover-photo">
      ...
      />
                ...
                <div className="hp-avatar-container">
                  ...
                  {userInfo.organization_logo && (
                    <img 
                      ...
                      alt="Organization" 
                      className="hp-organization-logo"
                    />
                  )}
                </div>
                <div className="hp-profile-info">
                  <h1 className="hp-name">{userInfo.username}</h1>
                  {userInfo.jobtitle && (
                    <p className="hp-title">{userInfo.jobtitle}</p>
                  )}
                  {userInfo.organization && (
                    <p className="hp-organization">{userInfo.organization}</p>
                  )}
                </div>
              </div>
            </header>
            ...
            {(userInfo.description ) && (
              <section className="hp-about-section">
                {userInfo.description && (
                  <div className="hp-bio">
                    <h3 className="hp-section-title">Professional Bio</h3>
            ...
            <section className="hp-social-section">
              <div className="hp-social-grid">
                {userInfo.linkedin_url && (
                  <a href={userInfo.linkedin_url} className="hp-social-link linkedin">
                    <i className="fab fa-linkedin-in"></i>
                    <span>LinkedIn</span>
                  </a>
                )}
                {userInfo.facebook_url && (
                  <a href={userInfo.facebook_url} className="hp-social-link facebook">
                    <i className="fab fa-facebook-f"></i>
                    <span>Facebook</span>
                  </a>
                )}
                {userInfo.instagram_url && (
                  <a href={userInfo.instagram_url} className="hp-social-link instagram">
                    <i className="fab fa-instagram"></i>
                    <span>Instagram</span>
                  </a>
                )}
                {userInfo.twitter_url && (
                  <a href={userInfo.twitter_url} className="hp-social-link twitter">
                    <i className="fab fa-twitter"></i>
                    <span>Twitter</span>
                  </a>
                )}
                {userInfo.youtube_url && (
                  <a href={userInfo.youtube_url} className="hp-social-link youtube">
