...
import "../styles/Developer.css"; // Create this file with the CSS below
    ...
    <>
      {!userPresent ? (
        ...
        <>
          ...
          <div className="d-modern-profile">
            {/* Cover Section */}
            <div className="d-cover-container">
              {userInfo.user_cover_photo ? (
                userInfo.user_cover_photo.endsWith(".mp4") ? (
                  <video className="d-cover-media" autoPlay loop muted>
                    <source src={userInfo.user_cover_photo} type="video/mp4" />
                  </video>
                ) : (
                  <img className="d-cover-media" src={userInfo.user_cover_photo} alt="Cover" />
                )
              ) : (
                <div className="d-cover-default"></div>
              )}
              <div className="d-cover-overlay"></div>
            </div>
            ...
            <div className="d-profile-content">
              ...
              <div className="d-profile-header">
                ...
                />
                <h1 className="d-profile-name">{userInfo.username}</h1>
                {userInfo.jobtitle && (
                  <p className="d-profile-title">{userInfo.jobtitle}</p>
                )}
                {userInfo.organization && (
                  <p className="d-profile-organization">
                    {userInfo.organization}
                  </p>
                )}
              </div>
              ...
              {/* Social Links */}
              <div className="d-social-section">
                <h3 className="d-messaging-section-title">Connect With Me</h3>
                <div className="d-social-grid">
                  ...
                  {userInfo.tiktok_url && (
                    <a href={userInfo.tiktok_url} className="social-link tiktok">
                      <i className="fab fa-tiktok"></i>
                    </a>
                  )}
                  {userInfo.reddit_url && (
                    <a href={userInfo.reddit_url} className="social-link reddit">
                      <i className="fab fa-reddit"></i>
                    </a>
                  )}
                  {userInfo.pinterest_url && (
                    <a href={userInfo.pinterest_url} className="social-link pinterest">
...
{(userInfo.whatsapp || userInfo.snapchat_url || userInfo.discord_url || userInfo.telegram_url || userInfo.viber || userInfo.wechat_url || userInfo.line_url) && (
  <div className="d-messaging-section mt-8">
    <h3 className="d-messaging-section-title">Message Me</h3>
    <div className="d-messaging-grid">
      {userInfo.whatsapp && (
        <a
          href={`https://wa.me/${userInfo.whatsapp}`}
          target="_blank"
          rel="noreferrer"
          className="d-messaging-link whatsapp"
        >
      ...
      {userInfo.snapchat_url && (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="d-messaging-link snapchat"
        >
      ...
      {userInfo.discord_url && (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="d-messaging-link discord"
        >
      ...
      {userInfo.telegram_url && (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="d-messaging-link telegram"
        >
      ...
      {userInfo.viber && (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="d-messaging-link viber"
        >
      ...
      {userInfo.wechat_url && (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="d-messaging-link wechat"
        >
...
{/* Messaging Section */}
          ...
          <footer className="d-modern-footer" style={{ backgroundColor: userInfo.user_colour || '#1c73ba' }}>
