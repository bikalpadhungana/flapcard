...
function Main() {
  ...
  function handleOrder() {
    window.location.href = "http://127.0.0.1:5173/place-order";
  }
  ...
  return (
    <div className="bg-[#E9ECF2] lg:mb-9">
      ...
      <div className="flex justify-between lg:flex-row flex-col py-9 md:pt-[60px] sm:pt-12 pt-9 gap-[60px] ">
        <div>
          <h1
            className=" text-[rgb(18,24,56)] lg:text-left text-center lg:w-[200px] lg:mx-[0px] md:mx-[100px] font-['Montserrat Alternates'] sm:font-[700] font-[600] sm:pb-10 pb-8 pt-9 tracking-wide leading-[55px] sm:leading-normal text-[clamp(2.2rem,6.8vw+1rem,4.5rem)]"
            style={{
          ...
          <div className="flex gap-9 justify-center">
            <button onClick={handleOrder} className="bg-[#143385] text-white py-2  sm:w-[180px] w-[120px] md:text-md text-xs font-semibold">
              ORDER NOW
            </button>
            <Link to="sign-up">
            <button className="bg-transparent border py-2  sm:w-[180px] w-[120px] md:text-sm text-xs border-[#143385] font-semibold text-[#143385]">
              EXPLORE
            </button>
            </Link>
          </div>
